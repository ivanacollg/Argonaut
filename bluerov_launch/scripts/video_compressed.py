...
if __name__ == '__main__':
    ...
    compressed_flag = rospy.get_param("~compressed_flag")

    if compressed_flag:
        img_compressed_pub = rospy.Publisher('/camera/image_raw/compressed', CompressedImage, queue_size=10)
    else:
    ...
    while not rospy.is_shutdown():
        ...
        if compressed_flag: 
            ...
            status, compressed = cv2.imencode(".jpg", frame, params)
            ...
            img_compressed_pub.publish(compressed_msg)
        else:
